...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Library Of ACG"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Library Of ACG"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://12880558406"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://12880558406"
    ...
    if UserInputService.TouchEnabled then
        ...
        ImageButton.MouseButton1Click:Connect(function()
            ...
            OrionLib:MakeNotification({
                Name = "Interface Hidden",
                Content = "Tap Button to reopen the interface",
                Time = 5
            })
            WindowConfig.CloseCallback()
           end
